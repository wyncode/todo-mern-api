...
const forgotPasswordEmail = (email, token, password) => {
  const exampleHTMLEmail = `<a  target="_blank" rel="noopener noreferrer" href="${APP_URL}/users/password/reset?email=${email}&token=${token}&password=${password}>Reset Password</a>`;
